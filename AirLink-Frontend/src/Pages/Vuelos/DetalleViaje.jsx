...
export default function DetalleViaje() {
    ...
    const datosViaje = location.state || JSON.parse(localStorage.getItem('vueloSeleccionado'));
    ...
    const calcularTotal = () => {
        let total = Number(datosViaje.vueloIda.precio);
        if (datosViaje.vueloVuelta) {
            total += Number(datosViaje.vueloVuelta.precio);
        }
        return total * datosViaje.pasajeros;
    };
        ...
        <div className="min-h-screen bg-gray-50">
            ...
            <div className="max-w-7xl mx-auto px-4 py-8">
                <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
                    {/* Columna izquierda: Detalles de vuelos */}
                                ...
                                <div className="flex items-center justify-between">
                                    ...
                                    <div className="flex-1 px-8">
                                        ...
                                        <div className="relative">
                                            ...
                                            <div className="absolute left-0 top-1/2 transform -translate-y-1/2 w-3 h-3 bg-purple-600 rounded-full"></div>
                        ...
                        <div className="bg-blue-50 border border-blue-200 rounded-lg p-6">
                            ...
                            <ul className="space-y-2 text-sm text-blue-800">
                                <li className="flex items-start gap-2">
                                    ...
                                    <span>Llega al aeropuerto con al menos 2 horas de anticipación para vuelos internacionales</span>
                                </li>
                                <li className="flex items-start gap-2">
                                    <span className="mt-1">•</span>
                        ...
                        <div className="bg-white rounded-lg shadow-md p-6 sticky top-6">
                            ...
                            <div className="space-y-3 mb-4 pb-4 border-b">
                                <div className="flex justify-between text-sm">
                                    ...
                                    <span className="font-semibold">
                                        ${Number(datosViaje.vueloIda.precio).toLocaleString('es-CL')}
                                    </span>
                                </div>
                                ...
                                {datosViaje.vueloVuelta && (
                                    <div className="flex justify-between text-sm">
                                        ...
                                        <span className="font-semibold">
                                            ${Number(datosViaje.vueloVuelta.precio).toLocaleString('es-CL')}
                                        </span>
                                    </div>
                                )}
                                ...
                                <div className="flex justify-between text-sm">
                                    ...
                                    <span className="font-semibold">{datosViaje.pasajeros}</span>
                                </div>
                            ...
                            <div className="mt-6 pt-6 border-t">
                                <div className="flex items-start gap-2 text-xs text-gray-500">
                                    <span>🔒</span>
                                    <span>
                                        Tus datos están protegidos. El precio final incluye todos los impuestos y tasas.
                                    </span>
                                </div>
                            </div>
                        </div>
